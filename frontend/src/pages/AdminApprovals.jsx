...
export default function AdminApprovals() {
  ...
  return (
    <div>
      ...
      {error && <p className="mb-6 rounded-2xl border border-red-200 bg-red-50 px-5 py-4 text-sm text-red-800 shadow-sm animate-fade-in">{error}</p>}
      ...
      <div className="animate-fade-in">
        ...
        <CardContent className="p-6 space-y-6">
          ...
          {loading && <p className="text-slate-500 font-medium">Loading…</p>}
                ...
                <tr key={b.id}>
                  <Td>
                    <input
                      ...
                      className="h-4 w-4 rounded-md border-slate-300 text-blue-600 focus:ring-blue-500/30"
                    />
                  </Td>
          ...
          {filtered.length === 0 && !loading && (
            <p className="text-center text-slate-500 py-10 font-medium bg-slate-50/50 rounded-xl border border-slate-100">No pending bookings match this filter.</p>
          )}
        </CardContent>
      </Card>
      </div>
